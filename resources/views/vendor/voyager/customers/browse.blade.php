...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
        @if( $advSearch )
            <a href="javascript:" class="btn btn-info btn-advSearch btn-filter filterToggle">
                <i class="voyager-search"></i> <span>{{ 'Advanced Search' }}</span>
            </a>
            <a href="javascript:" class="btn btn-default btn-builtInFilter btn-filter is_inactive filterToggle">
                    ...
                    <div class="panel-body">
                        @if ($isServerSide)
                            <div class="filterToggle">
                                @include('vendor.voyager.customers.partials.search')
                            </div>
                        @endif
                        @if( $advSearch )
                            <div class="is_inactive filterToggle">
                                <advanced_filter_panel></advanced_filter_panel>
                            </div>
                        @endif
...
@section('javascript')
    ...
    $dataTypeContent = $dataTypeContent->toArray();

    if( isset( $dataType['browse_rows'] ) ) {
        foreach ( $dataType['browse_rows'] as $k => $row_data ) {
            if( $row_data['type'] != 'relationship' ) {
                $field_list[$row_data['field']] = $row_data['display_name'];
                $field_type_list[$row_data['field']] = $row_data['type'];
            }
        }
    }
    ?>

    @include('vendor/voyager/components/advanced_filter_panel')
